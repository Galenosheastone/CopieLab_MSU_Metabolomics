...
fig <- fig %>% layout(scene = list(xaxis = list(title = "PC 1: INSERT_COMP1.var_HERE%"),
                     yaxis = list(title = "PC 2: INSERT_COMP2.var_HERE%"),
                     zaxis = list(title = "PC 3: INSERT_COMP3.var_HERE%")))
fig
